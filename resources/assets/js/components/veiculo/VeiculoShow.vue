        ...
        <div class="ui piled segment">
            ...
            <div class="ui vertically divided padded grid">
                <div class="four column row">
                    <div class="column"><b>Proprietário:</b> {{ veiculo.proprietario.nome }}</div>
                ...
                <div class="four column row">
                    ...
                    <div class="column"><b>Marca:</b> {{ veiculo.marca.descricao }}</div>
                    <div class="column"><b>Data da cotação:</b> {{ veiculo.data_cotacao }}</div>
                    <div class="column"><b>Preço:</b> {{ veiculo.preco | currency }}</div>
                </div>
                <div class="four column row">
                    <div class="column"><b>País:</b> {{ veiculo.pais.descricao }}</div>
